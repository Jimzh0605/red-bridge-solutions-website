...
export const Portal: React.FC = memo(() => {
  return (
    <div className="min-h-[80vh] bg-offwhite flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 shadow-lg border-t-4 border-primary relative overflow-hidden rounded-xl">
        ...
        {/* Badge */}
        <div className="absolute top-6 right-[-35px] transform rotate-45 bg-primary text-white text-xs font-bold py-1 px-10 shadow-md" aria-label="Coming Soon">
          COMING SOON
        </div>

        <div className="text-center">
          <Lock className="mx-auto h-12 w-12 text-primary opacity-80" aria-hidden="true" />
        ...
        <div className="mt-8 space-y-6 opacity-50 select-none pointer-events-none filter blur-[0.5px]" aria-hidden="true">
          <div className="rounded-md shadow-sm space-y-3">
            <div>
              ...
              <input
                ...
                type="email"
                autoComplete="email"
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md sm:text-sm"
