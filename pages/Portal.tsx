...
export const Portal: React.FC = () => {
  return (
    <div className="min-h-[80vh] bg-offwhite flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 shadow-lg border-t-4 border-burgundy relative overflow-hidden">
        
        {/* Badge */}
        <div className="absolute top-6 right-[-35px] transform rotate-45 bg-burgundy text-white text-xs font-bold py-1 px-10 shadow-md">
          COMING SOON
        </div>

        <div className="text-center">
          <Lock className="mx-auto h-12 w-12 text-burgundy opacity-80" />
        ...
        <div className="mt-8 space-y-6 opacity-50 select-none pointer-events-none filter blur-[0.5px]">
          ...
          <div>
            <button
              type="submit"
              disabled
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-burgundy focus:outline-none"
            >
              Sign in
            </button>
          </div>
        ...
        <div className="pt-6 border-t border-gray-100 text-center">
          <p className="text-sm text-gray-600 leading-relaxed">
            Our proprietary <span className="font-semibold text-burgundy">Client Hub</span> is currently in development.
          </p>
